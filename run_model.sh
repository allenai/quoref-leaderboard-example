...
python run_squad.py --do_eval --do_lower_case --train_file null --predict_file /tmp/input.json --output_dir xlnet_quoref_model_out --model_type xlnet --model_name_or_path xlnet-base-cased
